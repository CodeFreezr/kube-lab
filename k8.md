# Codelets for the Kubernetes Ecosystem
...
Together with a Default-Store for Default-Values we would think to simplify cli stuff a lot, and bring mor fun into cli based devopsing.
